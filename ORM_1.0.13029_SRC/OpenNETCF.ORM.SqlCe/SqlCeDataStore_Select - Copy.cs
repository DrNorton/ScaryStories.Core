...
namespace OpenNETCF.ORM
{
    partial class SqlCeDataStore
    {
        ...
        protected override T[] Select<T>(IEnumerable<FilterCondition> filters, int fetchCount, int firstRowOffset, bool fillReferences)
//            where T : class, new()
        {
...
//                            T item = new T();
        ...
        private ConstructorInfo GetConstructorForType(Type objectType)
        {
