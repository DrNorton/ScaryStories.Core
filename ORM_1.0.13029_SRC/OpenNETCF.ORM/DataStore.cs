...
namespace OpenNETCF.ORM
{
        ...
        where TEntityInfo : EntityInfo, new()
    {
        ...
        public abstract IEnumerable<T> Select<T>(bool fillReferences,int limit) where T : new();
        ...
        public IEnumerable<T> SelectRandom<T>(Func<T, bool> selector,int limit)
           where T : new()
        {
            return (from e in Select<T>(false)
                    where selector(e)
